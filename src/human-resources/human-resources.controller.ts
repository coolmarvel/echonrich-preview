...
import { FindDepartmentResDto, FindEmployeeResDto, FindJobHistoryResdto } from './dto/res.dto';
import { ApiGetItemsResponse, ApiGetResponse } from 'src/common/decorators/swagger.decorator';
import { FindDepartmentReqDto, FindEmployeeReqDto, FindJobHistoryReqdto } from './dto/req.dto';
import { PageReqDto } from 'src/common/dto/req.dto';
import { PageResDto } from 'src/common/dto/res.dto';

@ApiTags('Human-Resources')
@ApiExtraModels(FindEmployeeResDto, FindJobHistoryResdto, FindDepartmentResDto, PageResDto)
@Controller('api')
